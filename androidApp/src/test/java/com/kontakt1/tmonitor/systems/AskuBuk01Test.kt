...
class AskuBuk01Test {
    ...
    val timezoneForTest = TimeZone.getTimeZone("GMT+03:00")
        ...
        connection?.let {
            ...
            system.silabus.listSilo.forEach { silo ->
                ...
                silo.params.forEach { param ->
                    param.lParam?.let {
                        ps.println("${it}")
                        system.readIndicationsChart(connection,dateTimeFrom,dateTimeTo,it)
